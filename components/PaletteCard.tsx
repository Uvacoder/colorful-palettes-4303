...
export default function PaletteCard({ palette }: PaletteCardProps) {
  return (
    <Flex minW="200px" h="400px" flexDir="column" borderWidth="2px" borderRadius="15px" bgColor={`linear-gradient(304deg, ${palette.colors[0]}, 0%, ${palette.colors[4]}, 100%)`}>
      ...
      <Flex py="20px" justifyContent="center" flexDir="column" alignItems="center">
        ...
        <Tooltip label="The higher the rarest">
          <Text color="gray.400">Rarity score of {palette.rarityScore}</Text>
        </Tooltip>
